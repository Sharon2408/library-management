                         ...
                         <div class="row g-0">
                             ...
                             <div class="col-md-8">
                                 ...
                                 <div class="d-flex p-2">
                                     <a href={{ route('shelf.book', ['id' => $book->id]) }} class="btn btn-outline-warning p-1 me-2">Read Later</a>
                                     <a href="{{ asset('storage/' . $book->pdf) }}" class="btn btn-outline-primary p-1 me-2">Read Now</a>
                                 </div>
                             </div>
                         </div>
                     </div>
